...
# -----------------spectral features------------------
# spectral centroid
t_centroid = lb.feature.spectral_centroid(y=y, sr=sr, n_fft=n_fft, hop_length=hop_length)
...
# spectral bandwidth
t_bandwidth = lb.feature.spectral_bandwidth(y=y, sr=sr, n_fft=n_fft, hop_length=hop_length)
...
# spectral contrast
t_contrast = lb.feature.spectral_contrast(y=y, sr=sr, n_fft=n_fft, hop_length=hop_length)
...
# spectral flatness
t_flatness = lb.feature.spectral_flatness(y=y, n_fft=n_fft, hop_length=hop_length)
...
# spectral rolloff
t_rolloff = lb.feature.spectral_rolloff(y=y, sr=sr, n_fft=n_fft, hop_length=hop_length)
